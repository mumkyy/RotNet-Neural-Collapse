...
# Force collapse via inverse NC1 (within/between scatter) penalty, applied
# layerwise. Negative weights drive NC1 down (collapse); detach_sb stops
# gradient through the between-class scatter (stopgrad on features). No WD.
config['nc_reg'] = {
