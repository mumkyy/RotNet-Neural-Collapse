...
# Force collapse via inverse NC1 penalty on the FINAL feature layer only
# (penultimate GAP features feeding the classifier). Negative weight drives
# NC1 down (collapse); detach_sb = stopgrad on features. No WD.
config['nc_reg'] = {
    'layers': ['penult'],
    'weights': {
        'penult': -1e-3,
