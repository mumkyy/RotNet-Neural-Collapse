...
# Force collapse via inverse NC3 penalty on the FINAL layer only
# (penultimate GAP features vs classifier rows). Negative lambdaNC3 forces
# the classifier into self-duality (collapse). No WD.
config['nc3_reg'] = {
    'last_layer': 'penult',
