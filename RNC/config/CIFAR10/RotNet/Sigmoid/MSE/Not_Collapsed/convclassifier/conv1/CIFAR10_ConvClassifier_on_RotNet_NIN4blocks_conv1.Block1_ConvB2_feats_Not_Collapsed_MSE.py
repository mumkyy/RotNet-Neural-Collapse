...
feat_pretrained_file = './experiments/CIFAR10_RotNet_NIN4blocks_Sigmoid_Not_Collapsed_MSE/model_net_epoch200'
networks['feat_extractor'] = {'def_file': 'architectures/NetworkInNetwork_sigmoid.py', 'pretrained': feat_pretrained_file, 'opt': feat_net_opt,  'optim_params': None} 
...
cls_net_opt = {'num_classes':10, 'nChannels':160, 'cls_type':'NIN_ConvBlock3'}
...
config['out_feat_keys'] = ['conv1.Block1_ConvB2']
