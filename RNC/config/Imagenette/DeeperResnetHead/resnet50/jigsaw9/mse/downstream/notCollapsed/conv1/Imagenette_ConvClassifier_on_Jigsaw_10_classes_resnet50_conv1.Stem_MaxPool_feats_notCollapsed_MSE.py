...
feat_pretrained_file = '/scratch/amr239/gma35/experiments/Imagenette_Jigsaw9_resnet50_deeperHead_mse_backbone_not_collapsed_middle_classifier_penalty/model_net_epoch200'
...
cls_net_opt = {'num_classes':10, 'nChannels':64, 'cls_type':'NIN_ConvBlock3'}
...
config['out_feat_keys'] = ['conv1.Stem_MaxPool']
