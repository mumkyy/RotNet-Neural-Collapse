...
for exp in \
  "STL10/jigsaw9/MSE/Not_Collapsed/Backbone/STL10_Jigsaw9_resnet_Not_Collapsed_MSE_nc3Layerwise_withWD" \
  "STL10/jigsaw9/MSE/Not_Collapsed/Backbone/STL10_Jigsaw9_resnet_Not_Collapsed_MSE_nc3Layerwise_withoutWD"; do
