#!/bin/bash
# Submit the 4 force-collapse (no-WD) STL jigsaw9 resnet34 backbones, each its own job. No dependencies.
set -e
cd "$(dirname "$0")"
SCRATCH=/scratch/amr239/ai342/RNC_experiments/
for v in NC1Layerwise NC1Final NC3Layerwise NC3Final; do
  exp="STL10/jigsaw9/MSE/Collapsed/Backbone/STL10_Jigsaw9_resnet_Collapsed_MSE_${v}_noWD"
