...
feat_pretrained_file = './experiments/CIFAR10_RotNet_NIN4blocks_Not_Collapsed_MSE/model_net_epoch200'
...
cls_net_optim_params = {'optim_type': 'sgd', 'lr': 0.1, 'momentum':0.9, 'weight_decay': 5e-4, 'nesterov': True, 'LUT_lr':[(20, 0.1),(40, 0.02),(45, 0.004),(50, 0.0008)]}
cls_net_opt = {'num_classes':10, 'nChannels':192, 'cls_type':'MultLayer_GAP'}
