...
feat_pretrained_file = './experiments/CIFAR10_RotNet_NIN4blocks_Not_Collapsed_MSE/model_net_epoch61'
...
cls_net_opt = {'num_classes':10, 'nChannels':192, 'cls_type':'NIN_ConvBlock4'}
