...
data_train_opt['patch_dim']      = 14          
data_train_opt['gap']            = 1           # set to 0 or None to "disable" gap
data_train_opt['mode']           = 'QUAD'     # 'EIGHT' or 'QUAD'
data_train_opt['chromatic']      = True        
...
net_opt['num_classes'] = 4     # change to 4 if mode='QUAD'
