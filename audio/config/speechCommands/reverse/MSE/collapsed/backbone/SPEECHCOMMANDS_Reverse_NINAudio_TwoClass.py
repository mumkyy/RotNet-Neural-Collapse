...
data_train_opt['dataset_name'] = 'SPEECHCOMMANDS'
data_train_opt['split'] = 'train'
data_train_opt['pretext_mode'] = 'reverse'
...
data_test_opt['dataset_name'] = 'SPEECHCOMMANDS'
data_test_opt['split'] = 'test'
data_test_opt['pretext_mode'] = 'reverse'
...
networks['model'] = {'def_file': 'architectures/model.py',
                      'pretrained': None, 
                      'opt': net_opt,  
