...
python train_and_eval.py \
  --workdir /project/amr239/gma35/RotNet-Neural-Collapse/googleResultsRecreation/workdirs/DOWNSTREAM_COLLAPSED/LinearHead_Jig9_10Perms_40Epoch/block_1_small \
  --task downstream \
